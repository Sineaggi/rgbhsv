...
public class JmhMain {
    ...
    @Benchmark
    @Warmup(iterations = 1, time = 1, timeUnit = TimeUnit.SECONDS)
    public void ahsv_from_argb_vector2_128(Blackhole blackhole) {
        ahsv_from_argb_sse2(ahsv_a, ahsv_h, ahsv_s, ahsv_v,
                argb_a,argb_r, argb_g, argb_b, size, SPECIES_128);
        blackhole.consume(ahsv_a);
        blackhole.consume(ahsv_h);
        blackhole.consume(ahsv_s);
        blackhole.consume(ahsv_v);
    ...
    @Benchmark
    @Warmup(iterations = 1, time = 1, timeUnit = TimeUnit.SECONDS)
    public void argb_from_ahsv_vector2_128(Blackhole blackhole) {
        argb_from_ahsv_sse2(argb_a,argb_r, argb_g, argb_b,
                ahsv_a, ahsv_h, ahsv_s, ahsv_v, size, SPECIES_128);
        blackhole.consume(ahsv_a);
        blackhole.consume(ahsv_h);
        blackhole.consume(ahsv_s);
        blackhole.consume(ahsv_v);
